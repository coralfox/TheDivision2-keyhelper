...
if FileExist("TheDivision2.ini")
{
    ...
    IniRead , vNormalMode, TheDivision2.ini, 键鼠模式, 兼容模式, 1
    IniRead , vPlayMode, TheDivision2.ini, 键鼠模式, 游戏模式, 0
    IniRead , vDdMode, TheDivision2.ini, 键鼠模式, 驱动模式, 0
...
infoMenu:
    ...
    info .="`n键鼠操作模式:`t- " transit(vNormalMode,"liuMode") "`t`t-"
