...
NormalMode:
    ...
    vajMode := 1 ;1-兼容模式 2-游戏模式 3-驱动模式
    SendMode Event
    ; vPlayMode := 0
    ; vDdMode := 0
...
PlayMode:
    ...
    Menu , MySubMenu4, check, 游戏模式
    Menu , MySubMenu4, uncheck, 驱动模式
    vajMode := 2 ;1-兼容模式 2-游戏模式 3-驱动模式
    SendMode InputThenPlay
    ; vPlayMode := 1
    ; vDdMode := 0
...
DdMode:
    ...
    Menu , MySubMenu4, uncheck, 游戏模式
    Menu , MySubMenu4, check, 驱动模式
    vajMode := 3 ;1-兼容模式 2-游戏模式 3-驱动模式
    ; vNormalMode := 0
    ; vPlayMode := 0
    ; vDdMode := 1

    if vTtsSpeak
        Speak(vajMode==3 ? "助手按键已切换驱动模式" : )
