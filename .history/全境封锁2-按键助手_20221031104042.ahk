...
if FileExist("TheDivision2.ini")
{
    ...
    IniRead , vNormalMode, TheDivision2.ini, 无限溜溜球, 兼容模式, 1
    IniRead , vPlayMode, TheDivision2.ini, 无限溜溜球, 游戏模式, 0
    IniRead , vDdMode, TheDivision2.ini, 无限溜溜球, 驱动模式, 0
...
infoMenu:
    ...
    if vAutoLiu
    {
        ...
        . "`n键鼠操作模式:`t- " transit(vNormalMode,"liuMode") "`t`t-"
    }
