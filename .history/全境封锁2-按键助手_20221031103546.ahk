...
if FileExist("TheDivision2.ini")
{
    ...
    IniRead , vNormalMode, TheDivision2.ini, 无限溜溜球, 装配工模式, 1	;1-装配工,2固线
    IniRead , vgxLiu, TheDivision2.ini, 无限溜溜球, 固线模式, 0
    IniRead , vAutoGxLiu, TheDivision2.ini, 无限溜溜球,技能使用后自动重置固线, 0	;1-装配工,2固线
    ...
    IniRead , vShadowMode, TheDivision2.ini, 信息显示, 渐隐模式, 1	;1-装配工,2固线
    IniRead , vFixMode, TheDivision2.ini, 信息显示, 固定模式, 0
    IniRead , vTtsSpeak, TheDivision2.ini, 信息显示,TTS语音通报, 1	;1-装配工,2固线
...
NormalMode:
    ...
    if vTtsSpeak
        Speak(vNormalMode ? "溜溜球按键已切换兼容模式" : )

    IniWrite, % vNormalMode, TheDivision2.ini, 操作模式, 兼容模式
    IniWrite, % vPlayMode, TheDivision2.ini, 操作模式, 游戏模式
    IniWrite, % vDdMode, TheDivision2.ini, 操作模式, 驱动模式
return
...
PlayMode:
    ...
    if vTtsSpeak
        Speak(vNormalMode ? "溜溜球按键已切换游戏模式" : )
...
DdMode:
    ...
    if vTtsSpeak
        Speak(vNormalMode ? "溜溜球按键已切换驱动模式" : )
