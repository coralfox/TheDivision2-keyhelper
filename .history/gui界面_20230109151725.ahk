...
Gui Tab, 4
Gui Font, W560, Segoe UI
Gui Add, Text,xs+10 ys+20 BackgroundWhite section, 目前连射模式
Gui Font
Gui Font, W560, Segoe UI
Gui Add, GroupBox,xs ys W450 h100 section, 简单模式
Gui Font
Gui Add, edit, xs+25 y+m w160 vClose, 启动后关闭小蓝熊
Gui Add, CheckBox, xs+25 y+m w80 vShootMode, 
Gui Add, Hotkey, x+20 yp-2 H18 vShootModeHotkey
